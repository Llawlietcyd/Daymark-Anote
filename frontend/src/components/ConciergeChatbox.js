  ...
  const copy = useMemo(() => (
    lang === 'zh'
      ? {
          ...
          placeholder: '比如：中期 check-in 是什么时候；Anote fellowship 的 3 个 deliverables 是什么',
          send: '发送',
          thinking: '思考中...',
      ...
      : {
          ...
          placeholder: 'Try: “When is the midpoint check-in?” or “What are the 3 fellowship deliverables?”',
          send: 'Send',
          thinking: 'Thinking...',
