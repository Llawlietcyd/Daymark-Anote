# Daymark Fellowship OS

This folder is a take-home adaptation of Daymark for the public [Anote AI Research Fellowship](https://github.com/anote-ai/Anote-AI-Research-Fellowship) materials.

What is different in this version:
- adds a dedicated `Fellowship` page that turns the public summer calendar into a program board
- imports fellowship milestones and recurring rituals into Daymark's existing task system
